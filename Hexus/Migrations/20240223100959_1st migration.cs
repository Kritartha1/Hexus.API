        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Server_ServerId",
                        column: x => x.ServerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServerUser_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServerUser_Server_ServersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Channels_Texts_TextId",
                        column: x => x.TextId,
                        principalTable: "Texts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Channels_Voices_VoiceId",
                        column: x => x.VoiceId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "10538139-dbb7-40be-9119-5c2297e16e10", "10538139-dbb7-40be-9119-5c2297e16e10", "SuperAdmin", "SUPERADMIN" },
                    { "987c7f4b-3a86-4c16-a2cf-a3f172b63175", "987c7f4b-3a86-4c16-a2cf-a3f172b63175", "Admin", "ADMIN" },
                    { "b4e76a9c-e602-436c-a655-c028ff59e537", "b4e76a9c-e602-436c-a655-c028ff59e537", "Moderator", "MODERATOR" },
                    { "b62bc63a-78f6-4fc3-b2ab-16b0244a222d", "b62bc63a-78f6-4fc3-b2ab-16b0244a222d", "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Channels_TextId",
                table: "Channels",
                column: "TextId");

            migrationBuilder.CreateIndex(
                name: "IX_Channels_VoiceId",
                table: "Channels",
                column: "VoiceId");
